...
\textbf{Priority impact:} Recovery rates greatly impacted by claim priority; higher for secured bank loans than secured bonds.

\textbf{Negative correlation:} Strong stylized fact—negative correlation between default likelihood and recovery. OLS regression (Moody's 1983–2023 data): coefficient $-6.56$ (p-value $2.8 \times 10^{-8}$), $R^2 = 55\%$.

\textbf{Amplification effect:} Credit spread = default probability $\times$ loss given default (equation 8.3). Negative correlation between these factors amplifies credit spread variations.
